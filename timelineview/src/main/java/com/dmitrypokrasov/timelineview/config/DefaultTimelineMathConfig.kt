...
/**
 * Стандартная реализация конфигурации параметров позиционирования и размеров таймлайна.
 */
data class DefaultTimelineMathConfig(
    ...
    override fun withSteps(steps: List<TimelineStep>): TimelineMathConfig = copy(steps = steps)
}
